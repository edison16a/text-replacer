...
function build() {
  ...
  // No _comment key in the output. The file is data that other code reads by
  // key, and a documentation string sitting in the same namespace as the real
  // entries is something every consumer then has to remember to skip.
  // data/README.md carries the explanation instead.
  return { palette, roles: sortedRoles };
}
